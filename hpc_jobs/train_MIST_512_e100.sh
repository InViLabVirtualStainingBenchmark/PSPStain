...
apptainer exec \
    ...
    "$CONTAINER" \
    bash -c 'echo "  trainA: $(ls /data/MIST-HER2/trainA | wc -l) images"; echo "  trainB: $(ls /data/MIST-HER2/trainB | wc -l) images"'
...
echo ""
echo "MIST-HER2 full training complete. Next step: sbatch infer_MIST_full.sh"
