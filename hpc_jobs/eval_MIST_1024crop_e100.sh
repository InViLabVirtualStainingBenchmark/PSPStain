#!/bin/bash
#SBATCH --job-name=pspstain_eval_MIST_1024crop_e100
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -p ampere_gpu
#SBATCH --gres=gpu:1
#SBATCH -o /data/antwerpen/212/vsc21212/projects/pspstain/logs/eval_MIST_1024crop_e100.%j.out
#SBATCH -e /data/antwerpen/212/vsc21212/projects/pspstain/logs/eval_MIST_1024crop_e100.%j.err

# eval_MIST_1024crop_e100.sh
# Runs evaluate.py on PSPStain MIST-HER2 inference outputs using the shared
# evaluate_nvidia.sif container.
#
# Submit ONLY after infer_MIST_1024crop_e100.sh has completed and image count is correct.
# Submit: sbatch eval_MIST_1024crop_e100.sh
#
# Results appended to:
...
if [ ! -d "$PRED_DIR" ]; then
    ...
    echo "Has infer_MIST_1024crop_e100.sh completed successfully?"
    exit 1
fi
