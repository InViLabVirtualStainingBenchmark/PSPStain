#!/bin/bash
#SBATCH --job-name=pspstain_MIST_512_p1
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -p ampere_gpu
#SBATCH --gres=gpu:1
#SBATCH -o /data/antwerpen/212/vsc21212/projects/pspstain/logs/train_MIST_512_p1.%j.out
#SBATCH -e /data/antwerpen/212/vsc21212/projects/pspstain/logs/train_MIST_512_p1.%j.err

# train_MIST_512_e100_part1.sh
...
# Monitor:
#   squeue -u $USER
#   tail -f $VSC_DATA/projects/pspstain/logs/train_MIST_512_p1.<jobid>.out
#
# Checkpoints saved at epoch 25 and epoch 50 (plus latest after every epoch):
#   $VSC_DATA/projects/pspstain/outputs/checkpoints/MIST-HER2_512_e100/
...
nvidia-smi --query-gpu=timestamp,utilization.gpu,memory.used,memory.total \
           --format=csv -l 5 \
    > "$VSC_DATA/projects/pspstain/logs/gpu_train_MIST_512_p1.csv" & GPU_LOG_PID=$!
...
echo ""
echo "=== GPU log tail ==="
tail -3 "$VSC_DATA/projects/pspstain/logs/gpu_train_MIST_512_p1.csv"
