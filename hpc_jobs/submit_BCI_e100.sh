#!/bin/bash
# submit_BCI_e100.sh
# Submission wrapper for the two-part BCI 100-epoch training.
...
#   sbatch hpc_jobs/infer_BCI_1024crop_e100.sh

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PART1="$SCRIPT_DIR/train_BCI_1024crop_e100_part1.sh"
PART2="$SCRIPT_DIR/train_BCI_1024crop_e100_part2.sh"
...
echo "=== Submitting BCI 100-epoch training (2 parts) ==="
...
echo "Part 1 log:   tail -f \$VSC_DATA/projects/pspstain/logs/train_BCI_1024crop_p1.$JOB1.out"
echo "Part 2 log:   tail -f \$VSC_DATA/projects/pspstain/logs/train_BCI_1024crop_p2.$JOB2.out"
echo ""
echo "After both complete, submit inference:"
echo "  sbatch hpc_jobs/infer_BCI_1024crop_e100.sh"
