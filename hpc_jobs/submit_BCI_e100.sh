...
#   sbatch hpc_jobs/512_e100/infer_BCI_512_e100.sh

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PART1="$SCRIPT_DIR/train_BCI_512_e100_part1.sh"
PART2="$SCRIPT_DIR/train_BCI_512_e100_part2.sh"
...
echo "Part 1 log:   tail -f \$VSC_DATA/projects/pspstain/logs/train_BCI_512_p1.$JOB1.out"
echo "Part 2 log:   tail -f \$VSC_DATA/projects/pspstain/logs/train_BCI_512_p2.$JOB2.out"
echo ""
echo "After both complete, submit inference:"
echo "  sbatch hpc_jobs/512_e100/infer_BCI_512_e100.sh"
