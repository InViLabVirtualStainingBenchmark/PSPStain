...
#   $VSC_DATA/projects/pspstain/outputs/results/BCI_full_e100/val_latest/images/fake_B/
#
# Verify after job:
#   find $VSC_DATA/projects/pspstain/outputs/results/BCI_full_e100 -name "*.png" | wc -l
#   Expected: 977
...
apptainer exec \
    ...
    "$CONTAINER" \
    bash -c 'echo "  valA: $(ls /data/BCI-AB/valA | wc -l) images"'
