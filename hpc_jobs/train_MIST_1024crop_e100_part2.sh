#!/bin/bash
#SBATCH --job-name=pspstain_MIST_1024crop_p2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -p ampere_gpu
#SBATCH --gres=gpu:1
#SBATCH -o /data/antwerpen/212/vsc21212/projects/pspstain/logs/train_MIST_1024crop_p2.%j.out
#SBATCH -e /data/antwerpen/212/vsc21212/projects/pspstain/logs/train_MIST_1024crop_p2.%j.err

# train_MIST_1024crop_e100_part2.sh
...
# Monitor:
#   squeue -u $USER
#   tail -f $VSC_DATA/projects/pspstain/logs/train_MIST_1024crop_p2.<jobid>.out
#
...
nvidia-smi --query-gpu=timestamp,utilization.gpu,memory.used,memory.total \
           --format=csv -l 5 \
    > "$VSC_DATA/projects/pspstain/logs/gpu_train_MIST_1024crop_p2.csv" & GPU_LOG_PID=$!
...
echo ""
echo "=== GPU log tail ==="
tail -3 "$VSC_DATA/projects/pspstain/logs/gpu_train_MIST_1024crop_p2.csv"
